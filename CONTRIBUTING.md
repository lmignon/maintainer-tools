...
```
This rule doesn't apply to tests since the test files are loaded only when running tests and in such a case
your module and their external dependencies are isntalled
